            ...
            </div>
                {
                    isLogin ?
                        ...
                        <div className={cssObj["create-area"]}>
                            ...
                            <div className={cssObj["label"]}>用户名</div>
                            <div>
                                <input type="text" value={this.state.createName} onChange={(e) => { textChanged(e, "createName") }} />
                            </div>
                            <div className={cssObj["label"]}>电子邮件</div>
                            <div>
                                <input type="text" value={this.state.createEmail} onChange={(e) => { textChanged(e, "createEmail") }} />
                            </div>
                            <div className={cssObj["label"]}>手机号</div>
                            <div>
                                <input type="text " value={this.state.createPhone} onChange={(e) => { textChanged(e, "createPhone") }} />
                            </div>
                            <div className={cssObj["label"]}>密码</div>
                            <div>
                                <input type="password" value={this.state.createPassword} onChange={(e) => { textChanged(e, "createPassword") }} />
                            </div>
                            <div className={cssObj["label"]}>重复密码</div>
                            <div>
                                <input type="password" value={this.state.createRepeatPassword} onChange={(e) => { textChanged(e, "createRepeatPassword") }} />
                            </div>
